...
Whether we reuse entire source files or libraries, or we paste source code from third-party authors, we must properly credit them.
  ...
  // credits: SOURCE_URL
  ```
  Where `SOURCE_URL` is the url of the code we reused. That way we may be able to automatically create a document that summarizes such credits
